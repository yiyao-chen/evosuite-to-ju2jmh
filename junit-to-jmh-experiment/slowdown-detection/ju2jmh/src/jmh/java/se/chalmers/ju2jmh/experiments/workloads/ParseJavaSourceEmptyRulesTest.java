...
public class ParseJavaSourceEmptyRulesTest extends ParseJavaSourceTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.experiments.workloads.ParseJavaSourceTest._Benchmark {
        ...
        public org.junit.runners.model.Statement applyClassRuleFields(org.junit.runners.model.Statement statement, org.junit.runner.Description description) {
            statement = this.applyRule(ParseJavaSourceEmptyRulesTest.emptyClassRuleField, statement, description);
        ...
        public org.junit.runners.model.Statement applyClassRuleMethods(org.junit.runners.model.Statement statement, org.junit.runner.Description description) {
            statement = this.applyRule(ParseJavaSourceEmptyRulesTest.emptyClassRuleMethod(), statement, description);
        ...
        private ParseJavaSourceEmptyRulesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ParseJavaSourceEmptyRulesTest();
        }

        @java.lang.Override
        public ParseJavaSourceEmptyRulesTest implementation() {
